...
import type { KnCategoryVM, KnNoteVM, KnPrincipleVM, KnSystemVM, FuenteTipo, FuenteLongitud } from "./knowledge";
...
export async function listKnNotes(): Promise<KnNoteVM[]> {
  ...
  const { data, error } = await supabase
    .schema("personal")
    .from("kn_notes")
    .select("id, title, content, source, category_id, nota_bruta, fuente_tipo, fuente_nombre, fuente_longitud, puntos_clave, created_at")
